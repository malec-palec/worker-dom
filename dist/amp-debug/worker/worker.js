var WorkerThread = (function (exports) {
    ...
    _createClass(AMP, [{
      ...
      value: function getState() {
        ...
        return new Promise(function (resolve) {
          ...
          transfer(_this.document, [12 /* TransferrableMutationType.STORAGE */, 1 /* GetOrSet.GET */, 2 /* StorageLocation.AmpState */, /* key */store$1(key) + 1, /* value */0]);
      ...
      value: function setState(state) {
        ...
        transfer(this.document, [12 /* TransferrableMutationType.STORAGE */, 2 /* GetOrSet.SET */, 2 /* StorageLocation.AmpState */, /* key */0, /* value */store$1(stringified) + 1]);
      }
    }]);
    return AMP;
  }();
  ...
  function callFunctionMessageHandler(event, document) {
    ...
    if (!fn) {
      transfer(document, [13 /* TransferrableMutationType.FUNCTION_CALL */, 2 /* ResolveOrReject.REJECT */, index, store$1(JSON.stringify("[worker-dom]: Exported function \"".concat(fnIdentifier, "\" could not be found.")))]);
      return;
    }
    ...
    .then(function (f) {
      ...
      transfer(document, [13 /* TransferrableMutationType.FUNCTION_CALL */, 1 /* ResolveOrReject.RESOLVE */, index, store$1(JSON.stringify(value))]);
    }, function (err) {
      var errorMessage = JSON.stringify(err.message || err);
      transfer(document, [13 /* TransferrableMutationType.FUNCTION_CALL */, 2 /* ResolveOrReject.REJECT */, index, store$1(JSON.stringify("[worker-dom]: Function \"".concat(fnIdentifier, "\" threw: \"").concat(errorMessage, "\"")))]);
    });
  }
  ...
  var MutationObserver = /*#__PURE__*/function () {
    function MutationObserver(callback) {
      ...
      this[42 /* TransferrableKeys.records */] = [];
      this.target = void 0;
      this.options = void 0;
    ...
    _createClass(MutationObserver, [{
      ...
      value: function takeRecords() {
        var records = this[42 /* TransferrableKeys.records */];
  ...
  var Node = /*#__PURE__*/function () {
    function Node(nodeType, nodeName, ownerDocument, overrideIndex) {
      ...
      this[45 /* TransferrableKeys.scopingRoot */] = void 0;
      this.nodeType = void 0;
      this.nodeName = void 0;
      this.childNodes = [];
      this.parentNode = null;
      this.isConnected = false;
      this[7 /* TransferrableKeys.index */] = void 0;
      this[9 /* TransferrableKeys.transferredFormat */] = void 0;
      this[8 /* TransferrableKeys.creationFormat */] = void 0;
      this[10 /* TransferrableKeys.handlers */] = {};
      this.nodeType = nodeType;
      this.nodeName = nodeName;
      this.ownerDocument = ownerDocument || this;
      this[45 /* TransferrableKeys.scopingRoot */] = this;
      this[7 /* TransferrableKeys.index */] = overrideIndex ? storeOverride(this, overrideIndex) : store(this);
    ...
    _createClass(Node, [{
      ...
      value: function insertBefore(child, referenceNode) {
        ...
        if (child.nodeType === 11 /* NodeType.DOCUMENT_FRAGMENT_NODE */) {
          ...
          mutate(this.ownerDocument, {
            ...
            target: this
          }, [2 /* TransferrableMutationType.CHILD_LIST */, this[7 /* TransferrableKeys.index */], referenceNode[7 /* TransferrableKeys.index */], 0, 1, 0, child[7 /* TransferrableKeys.index */]]);
      ...
      value: function _(child) {
        ...
        propagate$3(child, 45 /* TransferrableKeys.scopingRoot */, this[45 /* TransferrableKeys.scopingRoot */]);
      }
      /**
      ...
      value: function _(child) {
        ...
        propagate$3(child, 45 /* TransferrableKeys.scopingRoot */, child);
      }
      /**
      ...
      value: function appendChild(child) {
        if (child.nodeType === 11 /* NodeType.DOCUMENT_FRAGMENT_NODE */) {
          ...
          mutate(this.ownerDocument, {
            ...
            type: 2 /* MutationRecordType.CHILD_LIST */,
            target: this
          }, [2 /* TransferrableMutationType.CHILD_LIST */, this[7 /* TransferrableKeys.index */], 0, previousSibling ? previousSibling[7 /* TransferrableKeys.index */] : 0, 1, 0, child[7 /* TransferrableKeys.index */]]);
        }
      ...
      value: function replaceChild(newChild, oldChild) {
        ...
        mutate(this.ownerDocument, {
          ...
          target: this
        }, [2 /* TransferrableMutationType.CHILD_LIST */, this[7 /* TransferrableKeys.index */], this.childNodes[index + 1] ? this.childNodes[index + 1][7 /* TransferrableKeys.index */] : 0, 0, 1, 1, newChild[7 /* TransferrableKeys.index */], oldChild[7 /* TransferrableKeys.index */]]);
      ...
      value: function addEventListener(type, handler) {
        ...
        var handlers = this[10 /* TransferrableKeys.handlers */][lowerType];
        var index = 0;
        if (handlers) {
        ...
        transfer(this.ownerDocument, [4 /* TransferrableMutationType.EVENT_SUBSCRIPTION */, this[7 /* TransferrableKeys.index */], 0, 1, storedType, index, Number(Boolean(options.capture)), Number(Boolean(options.once)), Number(Boolean(options.passive)), Number(Boolean(options.workerDOMPreventDefault))]);
      }
      /**
      ...
      value: function removeEventListener(type, handler) {
        ...
        if (index >= 0) {
          ...
          transfer(this.ownerDocument, [4 /* TransferrableMutationType.EVENT_SUBSCRIPTION */, this[7 /* TransferrableKeys.index */], 1, 0, store$1(lowerType), index]);
        }
      }
      /**
  ...
  function getPreviousElementSibling(node) {
    ...
    for (var i = parentNodes.indexOf(node) - 1; i >= 0; i--) {
      ...
      if (_node.nodeType === 1 /* NodeType.ELEMENT_NODE */) {
        return _node;
      }
    }
    return null;
  ...
  function getNextElementSibling(node) {
    ...
    for (var i = parentNodes.indexOf(node) + 1; i < parentNodes.length; i++) {
      ...
      if (_node2.nodeType === 1 /* NodeType.ELEMENT_NODE */) {
        return _node2;
      }
    }
    return null;
  ...
  var CharacterData = /*#__PURE__*/function (_Node) {
    ...
    function CharacterData(data, nodeType, nodeName, ownerDocument, overrideIndex) {
      ...
      _this[38 /* TransferrableKeys.data */] = void 0;
      _this[38 /* TransferrableKeys.data */] = data;
      _this[8 /* TransferrableKeys.creationFormat */] = [_this[7 /* TransferrableKeys.index */], nodeType, store$1(nodeName), store$1(data), 0];
      return _this;
    }
    // Unimplemented Methods
    ...
    _createClass(CharacterData, [{
      ...
      set: function set(value) {
        ...
        mutate(this.ownerDocument, {
          ...
          value: value,
          oldValue: oldValue
        }, [1 /* TransferrableMutationType.CHARACTER_DATA */, this[7 /* TransferrableKeys.index */], store$1(value)]);
      }
      /**
  ...
  var Comment = /*#__PURE__*/function (_CharacterData) {
    ...
    function Comment(data, ownerDocument, overrideIndex) {
      ...
      return _super.call(this, data, 8 /* NodeType.COMMENT_NODE */, '#comment', ownerDocument, overrideIndex);
    }
    /**
  ...
  */
  ...
  function _querySelectorAll(node, selector) {
    ...
    return matcher ? matchChildrenElements(node[45 /* TransferrableKeys.scopingRoot */], matcher).filter(function (element) {
  ...
  var DOMTokenList = /*#__PURE__*/function () {
    ...
    function DOMTokenList(target, attributeName) {
      ...
      this[43 /* TransferrableKeys.tokens */] = [];
      this[13 /* TransferrableKeys.target */] = void 0;
      this[18 /* TransferrableKeys.attributeName */] = void 0;
      this[44 /* TransferrableKeys.storeAttribute */] = void 0;
    ...
    _createClass(DOMTokenList, [{
      ...
      function set(collection) {
        ...
        (_this$ = this[43 /* TransferrableKeys.tokens */]).splice.apply(_this$, [0, this[43 /* TransferrableKeys.tokens */].length].concat(_toConsumableArray(newValue !== '' ? newValue.split(/\s+/) : '')));
      ...
      value: function add() {
        ...
        (_this$2 = this[43 /* TransferrableKeys.tokens */]).splice.apply(_this$2, [0, this[43 /* TransferrableKeys.tokens */].length].concat(_toConsumableArray(Array.from(new Set(this[43 /* TransferrableKeys.tokens */].concat(tokens))))));
      ...
      value: function remove() {
        ...
        var oldValue = this.value;
        (_this$3 = this[43 /* TransferrableKeys.tokens */]).splice.apply(_this$3, [0, this[43 /* TransferrableKeys.tokens */].length].concat(_toConsumableArray(Array.from(new Set(this[43 /* TransferrableKeys.tokens */].filter(function (token) {
      ...
      value: function replace(token, newToken) {
        ...
        var oldValue = this.value;
        var set = new Set(this[43 /* TransferrableKeys.tokens */]);
        if (token !== newToken) {
          set.delete(token);
          if (newToken !== '') {
            set.add(newToken);
        ...
        (_this$4 = this[43 /* TransferrableKeys.tokens */]).splice.apply(_this$4, [0, this[43 /* TransferrableKeys.tokens */].length].concat(_toConsumableArray(Array.from(set))));
        this[67 /* TransferrableKeys.mutated */](oldValue, this.value);
      }
      /**
      ...
      value: function _(oldValue, value) {
        ...
        mutate(this[13 /* TransferrableKeys.target */].ownerDocument, {
          ...
          value: value,
          oldValue: oldValue
        }, [0 /* TransferrableMutationType.ATTRIBUTES */, this[13 /* TransferrableKeys.target */][7 /* TransferrableKeys.index */], store$1(this[18 /* TransferrableKeys.attributeName */]), 0, value !== null ? store$1(value) + 1 : 0]);
      }
    }]);
    return DOMTokenList;
  }();
  ...
  var CSSStyleDeclaration = /*#__PURE__*/function () {
    ...
    _createClass(CSSStyleDeclaration, [{
      ...
      get: function get() {
        var value;
        var returnValue = '';
        for (var key in this[3 /* TransferrableKeys.properties */]) {
      ...
      value: function mutated(value) {
        var oldValue = this[44 /* TransferrableKeys.storeAttribute */](this[13 /* TransferrableKeys.target */].namespaceURI, 'style', value);
        mutate(this[13 /* TransferrableKeys.target */].ownerDocument, {
          type: 0 /* MutationRecordType.ATTRIBUTES */,
          target: this[13 /* TransferrableKeys.target */],
          attributeName: 'style',
          value: value,
          oldValue: oldValue
        }, [0 /* TransferrableMutationType.ATTRIBUTES */, this[13 /* TransferrableKeys.target */][7 /* TransferrableKeys.index */], store$1('style'), 0, value !== null ? store$1(value) + 1 : 0]);
      }
    }]);
  ...
  var Event$1 = /*#__PURE__*/function () {
    function Event(type, opts) {
      ...
      this.type = void 0;
      this.scoped = void 0;
      this[50 /* TransferrableKeys.stop */] = false;
      this[51 /* TransferrableKeys.end */] = false;
      this.pageX = void 0;
      this.pageY = void 0;
      this.offsetX = void 0;
      this.offsetY = void 0;
  ...
  var targetFromTransfer = function targetFromTransfer(document, event) {
    if (event[13 /* TransferrableKeys.target */] !== null) {
      var index = event[13 /* TransferrableKeys.target */][0];
  ...
  function propagate$2(global) {
    ...
    document.addGlobalEventListener('message', function (_ref) {
      ...
      var event = data[39 /* TransferrableKeys.event */];
      var node = get(event[7 /* TransferrableKeys.index */]);
      if (node !== null) {
        node.dispatchEvent(Object.assign(new Event$1(event[12 /* TransferrableKeys.type */], {
  ...
  function definePropertyBackedAttributes(defineOn, attributes) {
    var sub = Object.create(defineOn[46 /* TransferrableKeys.propertyBackedAttributes */]);
  ...
  var Element = /*#__PURE__*/function (_ParentNode) {
    ...
    function Element(nodeType, localName, namespaceURI, ownerDocument, overrideIndex) {
      ...
      _this[8 /* TransferrableKeys.creationFormat */] = [_this[7 /* TransferrableKeys.index */], _this.nodeType, store$1(_this.localName), 0, _this.namespaceURI === null ? 0 : store$1(_this.namespaceURI)];
      return _this;
    }
    ...
    _createClass(Element, [{
      ...
      set: function set(html) {
        ...
        this.childNodes.forEach(function (n) {
          ...
          propagate$3(n, 45 /* TransferrableKeys.scopingRoot */, n);
        });
        mutate(this.ownerDocument, {
          removedNodes: this.childNodes,
          type: 2 /* MutationRecordType.CHILD_LIST */,
          target: this
        }, [2 /* TransferrableMutationType.CHILD_LIST */, this[7 /* TransferrableKeys.index */], 0, 0, 0, this.childNodes.length].concat(_toConsumableArray(this.childNodes.map(function (node) {
          return node[7 /* TransferrableKeys.index */];
        }))));
      ...
      value: function setAttributeNS(namespaceURI, name, value) {
        ...
        var propertyBacked = this.constructor[46 /* TransferrableKeys.propertyBackedAttributes */][name];
        ...
        var oldValue = this[44 /* TransferrableKeys.storeAttribute */](namespaceURI, name, valueAsString);
        mutate(this.ownerDocument, {
          type: 0 /* MutationRecordType.ATTRIBUTES */,
          target: this,
          attributeName: name,
          ...
          value: valueAsString,
          oldValue: oldValue
        }, [0 /* TransferrableMutationType.ATTRIBUTES */, this[7 /* TransferrableKeys.index */], store$1(name), store$1(namespaceURI), value !== null ? store$1(valueAsString) + 1 : 0]);
      }
    }, {
      key: "44",
      ...
      value: function removeAttributeNS(namespaceURI, name) {
        ...
        if (index >= 0) {
          ...
          mutate(this.ownerDocument, {
            ...
            attributeNamespace: namespaceURI,
            oldValue: oldValue
          }, [0 /* TransferrableMutationType.ATTRIBUTES */, this[7 /* TransferrableKeys.index */], store$1(name), store$1(namespaceURI), 0 // 0 means no value
          ]);
        }
      }
      /**
      ...
      value: function getBoundingClientRectAsync() {
        ...
        return new Promise(function (resolve) {
          var messageHandler = function messageHandler(_ref) {
            var data = _ref.data;
            if (data[12 /* TransferrableKeys.type */] === 6 /* MessageType.GET_BOUNDING_CLIENT_RECT */ && data[13 /* TransferrableKeys.target */][0] === _this3[7 /* TransferrableKeys.index */]) {
              _this3.ownerDocument.removeGlobalEventListener('message', messageHandler);
              var transferredBoundingClientRect = data[38 /* TransferrableKeys.data */];
              resolve({
          ...
          if (!_this3.ownerDocument.addGlobalEventListener || !_this3.isConnected) {
            ...
            transfer(_this3.ownerDocument, [5 /* TransferrableMutationType.GET_BOUNDING_CLIENT_RECT */, _this3[7 /* TransferrableKeys.index */]]);
  ...
  Element[46 /* TransferrableKeys.propertyBackedAttributes */] = {
    class: [function (el) {
  ...
  var appendGlobalEventProperties = function appendGlobalEventProperties(keys) {
    ...
    keysToAppend.forEach(function (key) {
      ...
      Object.defineProperty(HTMLElement.prototype, key, {
        ...
        set: function set(value) {
          var stored = this[76 /* TransferrableKeys.propertyEventHandlers */][normalizedKey];
          if (stored) {
  ...
  var HTMLElement = /*#__PURE__*/function (_Element) {
    ...
    function HTMLElement() {
      ...
      _this[76 /* TransferrableKeys.propertyEventHandlers */] = {};
      return _this;
    }
  ...
  */
  ...
  function serializeTransferrableObject(args) {
    ...
    for (var i = 0; i < args.length; i++) {
      ...
      if (typeof arg === 'string') {
        serialized.push(3 /* TransferrableObjectType.String */, store$1(arg));
        continue;
      }
      ...
      if (_typeof(arg) === 'object') {
        var serializedObject = arg[68 /* TransferrableKeys.serializeAsTransferrableObject */]();
  ...
  var CanvasGradient = /*#__PURE__*/function () {
    ...
    _createClass(CanvasGradient, [{
      ...
      value: function addColorStop(offset, color) {
        transfer(this.document, [9 /* TransferrableMutationType.OBJECT_MUTATION */, store$1('addColorStop'), 2].concat(_toConsumableArray(this[68 /* TransferrableKeys.serializeAsTransferrableObject */]()), _toConsumableArray(serializeTransferrableObject(Array.prototype.slice.call(arguments)))));
      }
    }, {
      key: "68",
      value: function _() {
  ...
  var OffscreenCanvasRenderingContext2DPolyfill = /*#__PURE__*/function () {
    ...
    _createClass(OffscreenCanvasRenderingContext2DPolyfill, [{
      ...
      value: function _(fnName, args) {
        transfer(this.canvasElement.ownerDocument, [9 /* TransferrableMutationType.OBJECT_MUTATION */, store$1(fnName), args.length].concat(_toConsumableArray(this[68 /* TransferrableKeys.serializeAsTransferrableObject */]()), _toConsumableArray(serializeTransferrableObject(args))));
      }
    }, {
      key: "68",
      value: function _() {
      ...
      value: function createObjectReference(objectId, creationMethod, creationArgs) {
        transfer(this.canvasElement.ownerDocument, [10 /* TransferrableMutationType.OBJECT_CREATION */, store$1(creationMethod), objectId, creationArgs.length].concat(_toConsumableArray(this[68 /* TransferrableKeys.serializeAsTransferrableObject */]()), _toConsumableArray(serializeTransferrableObject(creationArgs))));
      }
    }, {
      key: "canvas",
      get: function get() {
      ...
      value: function clearRect(x, y, w, h) {
        this[67 /* TransferrableKeys.mutated */]('clearRect', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "fillRect",
      value: function fillRect(x, y, w, h) {
        this[67 /* TransferrableKeys.mutated */]('fillRect', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "strokeRect",
      value: function strokeRect(x, y, w, h) {
        this[67 /* TransferrableKeys.mutated */]('strokeRect', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "roundRect",
      value: function roundRect(x, y, w, h, radii) {
        this[67 /* TransferrableKeys.mutated */]('roundRect', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "lineWidth",
      set: function set(value) {
        this[67 /* TransferrableKeys.mutated */]('lineWidth', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "fillText",
      value: function fillText(text, x, y, maxWidth) {
        this[67 /* TransferrableKeys.mutated */]('fillText', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "moveTo",
      value: function moveTo(x, y) {
        this[67 /* TransferrableKeys.mutated */]('moveTo', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "lineTo",
      value: function lineTo(x, y) {
        this[67 /* TransferrableKeys.mutated */]('lineTo', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "closePath",
      ...
      value: function rotate(angle) {
        this[67 /* TransferrableKeys.mutated */]('rotate', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "transform",
      value: function transform(a, b, c, d, e, f) {
        this[67 /* TransferrableKeys.mutated */]('transform', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "translate",
      value: function translate(x, y) {
        this[67 /* TransferrableKeys.mutated */]('translate', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "scale",
      value: function scale(x, y) {
        this[67 /* TransferrableKeys.mutated */]('scale', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "globalAlpha",
      set: function set(value) {
        this[67 /* TransferrableKeys.mutated */]('globalAlpha', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "globalCompositeOperation",
      set: function set(value) {
        this[67 /* TransferrableKeys.mutated */]('globalCompositeOperation', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "imageSmoothingQuality",
      set: function set(value) {
        this[67 /* TransferrableKeys.mutated */]('imageSmoothingQuality', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "fillStyle",
      set: function set(value) {
        this[67 /* TransferrableKeys.mutated */]('fillStyle', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "strokeStyle",
      set: function set(value) {
        this[67 /* TransferrableKeys.mutated */]('strokeStyle', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "shadowBlur",
      set: function set(value) {
        this[67 /* TransferrableKeys.mutated */]('shadowBlur', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "shadowColor",
      set: function set(value) {
        this[67 /* TransferrableKeys.mutated */]('shadowColor', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "shadowOffsetX",
      set: function set(value) {
        this[67 /* TransferrableKeys.mutated */]('shadowOffsetX', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "shadowOffsetY",
      set: function set(value) {
        this[67 /* TransferrableKeys.mutated */]('shadowOffsetY', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "filter",
      set: function set(value) {
        this[67 /* TransferrableKeys.mutated */]('filter', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "beginPath",
      ...
      value: function strokeText(text, x, y, maxWidth) {
        this[67 /* TransferrableKeys.mutated */]('strokeText', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "textAlign",
      set: function set(value) {
        this[67 /* TransferrableKeys.mutated */]('textAlign', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "textBaseline",
      set: function set(value) {
        this[67 /* TransferrableKeys.mutated */]('textBaseline', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "lineCap",
      set: function set(value) {
        this[67 /* TransferrableKeys.mutated */]('lineCap', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "lineDashOffset",
      set: function set(value) {
        this[67 /* TransferrableKeys.mutated */]('lineDashOffset', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "lineJoin",
      set: function set(value) {
        this[67 /* TransferrableKeys.mutated */]('lineJoin', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "miterLimit",
      set: function set(value) {
        this[67 /* TransferrableKeys.mutated */]('miterLimit', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "arc",
      value: function arc(x, y, radius, startAngle, endAngle, anticlockwise) {
        this[67 /* TransferrableKeys.mutated */]('arc', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "arcTo",
      value: function arcTo(x1, y1, x2, y2, radius) {
        this[67 /* TransferrableKeys.mutated */]('arcTo', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "direction",
      set: function set(value) {
        this[67 /* TransferrableKeys.mutated */]('direction', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "font",
      set: function set(value) {
        this[67 /* TransferrableKeys.mutated */]('font', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "ellipse",
      value: function ellipse(x, y, radiusX, radiusY, rotation, startAngle, endAngle, anticlockwise) {
        this[67 /* TransferrableKeys.mutated */]('ellipse', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "bezierCurveTo",
      value: function bezierCurveTo(cp1x, cp1y, cp2x, cp2y, x, y) {
        this[67 /* TransferrableKeys.mutated */]('bezierCurveTo', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "rect",
      value: function rect(x, y, width, height) {
        this[67 /* TransferrableKeys.mutated */]('rect', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "quadraticCurveTo",
      value: function quadraticCurveTo(cpx, cpy, x, y) {
        this[67 /* TransferrableKeys.mutated */]('quadraticCurveTo', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "imageSmoothingEnabled",
      set: function set(value) {
        this[67 /* TransferrableKeys.mutated */]('imageSmoothingEnabled', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "setLineDash",
      value: function setLineDash(lineDash) {
        ...
        this[67 /* TransferrableKeys.mutated */]('setLineDash', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "getLineDash",
      ...
      value: function clip(pathOrFillRule, fillRule) {
        ...
        this[67 /* TransferrableKeys.mutated */]('clip', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "fill",
      value: function fill(pathOrFillRule, fillRule) {
        ...
        this[67 /* TransferrableKeys.mutated */]('fill', Array.prototype.slice.call(arguments));
      }
      ...
      value: function setTransform(transformOrA, bOrC, cOrD, dOrE, eOrF, f) {
        ...
        this[67 /* TransferrableKeys.mutated */]('setTransform', Array.prototype.slice.call(arguments));
      }
    }, {
      ...
      value: function drawImage(image, dx, dy) {
        this[67 /* TransferrableKeys.mutated */]('drawImage', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "createImageData",
    ...
    return new Promise(function (resolve) {
      var messageHandler = function messageHandler(_ref) {
        ...
        if (data[12 /* TransferrableKeys.type */] === 10 /* MessageType.IMAGE_BITMAP_INSTANCE */ && data[73 /* TransferrableKeys.callIndex */] === callIndex) {
          ...
          var transferredImageBitmap = data[38 /* TransferrableKeys.data */];
  ...
  var FakeNativeCanvasPattern = /*#__PURE__*/function () {
    function FakeNativeCanvasPattern() {
      ...
      this[70 /* TransferrableKeys.patternImplementation */] = {};
      this[71 /* TransferrableKeys.patternUpgraded */] = false;
      this[72 /* TransferrableKeys.patternUpgradePromise */] = void 0;
    }
    _createClass(FakeNativeCanvasPattern, [{
      ...
      function _(canvas, image, repetition) {
        ...
        .then(function (instance) {
          ...
          _this[70 /* TransferrableKeys.patternImplementation */] = pattern;
          _this[71 /* TransferrableKeys.patternUpgraded */] = true;
        });
    ...
    _createClass(CanvasRenderingContext2DShim, [{
      ...
      value: function getOffscreenCanvasAsync(canvas) {
        ...
        var upgradePromise = new Promise(function (resolve) {
          var messageHandler = function messageHandler(_ref) {
            var data = _ref.data;
            if (data[12 /* TransferrableKeys.type */] === 9 /* MessageType.OFFSCREEN_CANVAS_INSTANCE */ && data[13 /* TransferrableKeys.target */][0] === canvas[7 /* TransferrableKeys.index */]) {
              document.removeGlobalEventListener('message', messageHandler);
              var transferredOffscreenCanvas = data[38 /* TransferrableKeys.data */];
      ...
      key: "roundRect",
      value: function roundRect(x, y, w, h, radii) {
        this.delegateFunc('roundRect', Array.prototype.slice.call(arguments));
      }
      /* DRAWING TEXT */
    }, {
      key: "fillText",
      ...
      set: function set(value) {
        ...
        if (value instanceof FakeNativeCanvasPattern && this.upgraded) {
          ...
          if (!value[71 /* TransferrableKeys.patternUpgraded */]) {
            ...
            value[72 /* TransferrableKeys.patternUpgradePromise */].then(function () {
      ...
      value: function createPattern(image, repetition) {
        ...
        if (this.polyfillUsed || image instanceof ImageBitmap) {
          ...
          fakePattern[69 /* TransferrableKeys.retrieveCanvasPattern */](this.canvas, image, repetition).then(function () {
  ...
  */
  ...
  var HTMLInputElement = /*#__PURE__*/function (_HTMLElement) {
    ...
    function HTMLInputElement() {
      ...
      _this[21 /* TransferrableKeys.value */] = '';
      _this.dirtyValue = false;
      _this[47 /* TransferrableKeys.checked */] = false;
      return _this;
    }
    _createClass(HTMLInputElement, [{
      ...
      set: function set(value) {
        ...
        transfer(this.ownerDocument, [3 /* TransferrableMutationType.PROPERTIES */, this[7 /* TransferrableKeys.index */], store$1('value'), 0 /* NumericBoolean.FALSE */, store$1(value)]);
      }
    }, {
      key: "valueAsDate",
      get: function get() {
      ...
      set: function set(value) {
        ...
        transfer(this.ownerDocument, [3 /* TransferrableMutationType.PROPERTIES */, this[7 /* TransferrableKeys.index */], store$1('checked'), 1 /* NumericBoolean.TRUE */, value === true ? 1 /* NumericBoolean.TRUE */ : 0 /* NumericBoolean.FALSE */]);
      }
      /**
  ...
  var HTMLOptionElement = /*#__PURE__*/function (_HTMLElement) {
    ...
    function HTMLOptionElement() {
      ...
      _this = _super.call.apply(_super, [this].concat(args));
      _this[52 /* TransferrableKeys.selected */] = false;
      return _this;
    }
    _createClass(HTMLOptionElement, [{
      ...
      set: function set(value) {
        ...
        transfer(this.ownerDocument, [3 /* TransferrableMutationType.PROPERTIES */, this[7 /* TransferrableKeys.index */], store$1('selected'), 1 /* NumericBoolean.TRUE */, this[52 /* TransferrableKeys.selected */] ? 1 /* NumericBoolean.TRUE */ : 0 /* NumericBoolean.FALSE */]);
      }
      /**
       * A Synonym for the Node.textContent property getter.
       * @see https://developer.mozilla.org/en-US/docs/Web/API/HTMLOptionElement
  ...
  definePropertyBackedAttributes(HTMLOptionElement, {
    selected: [function (el) {
      return String(el[52 /* TransferrableKeys.selected */]);
    }, function (el, value) {
  ...
  var HTMLProgressElement = /*#__PURE__*/function (_HTMLElement) {
    ...
    function HTMLProgressElement() {
      ...
      _this = _super.call.apply(_super, [this].concat(args));
      _this[48 /* TransferrableKeys.indeterminate */] = true;
      _this[21 /* TransferrableKeys.value */] = 0;
      _this.dirtyValue = false;
      return _this;
    }
  ...
  var HTMLSelectElement = /*#__PURE__*/function (_HTMLElement) {
    ...
    function HTMLSelectElement() {
      ...
      _this = _super.call.apply(_super, [this].concat(args));
      _this[49 /* TransferrableKeys.size */] = -1 /* SizeDefaults.UNMODIFIED */;
      return _this;
    }
    _createClass(HTMLSelectElement, [{
       ...
       */
      function _(child) {
        _get(_getPrototypeOf(HTMLSelectElement.prototype), 56 /* TransferrableKeys.insertedNode */, this).call(this, child);
      ...
      key: "57",
      value: function _(child) {
        _get(_getPrototypeOf(HTMLSelectElement.prototype), 57 /* TransferrableKeys.removedNode */, this).call(this, child);
      ...
      key: "size",
      get: function get() {
        return this[49 /* TransferrableKeys.size */] === -1 /* SizeDefaults.UNMODIFIED */ ? this.multiple ? 4 /* SizeDefaults.MULTIPLE */ : 1 /* SizeDefaults.SINGLE */ : this[49 /* TransferrableKeys.size */];
      }
      /**
  ...
  var Text = /*#__PURE__*/function (_CharacterData) {
    ...
    function Text(data, ownerDocument, overrideIndex) {
      ...
      return _super.call(this, data, 3 /* NodeType.TEXT_NODE */, '#text', ownerDocument, overrideIndex);
    }
    // Unimplemented Properties
  ...
  var DocumentFragment = /*#__PURE__*/function (_ParentNode) {
    ...
    function DocumentFragment(ownerDocument, overrideIndex) {
      ...
      _this = _super.call(this, 11 /* NodeType.DOCUMENT_FRAGMENT_NODE */, '#document-fragment', ownerDocument, overrideIndex);
      _this[8 /* TransferrableKeys.creationFormat */] = [_this[7 /* TransferrableKeys.index */], 11 /* NodeType.DOCUMENT_FRAGMENT_NODE */, store$1(_this.nodeName), 0, 0];
      return _this;
    }
    /**
     * @param deep boolean determines if the clone should include a recursive copy of all childNodes.
  ...
  function propagate$1(global) {
    ...
    document.addGlobalEventListener('message', function (_ref) {
      ...
      var sync = data[40 /* TransferrableKeys.sync */];
      var node = get(sync[7 /* TransferrableKeys.index */]);
      if (node) {
  ...
  var Document = /*#__PURE__*/function (_Element) {
    ...
    function Document(global) {
      ...
      _this = _super.call(this, 9 /* NodeType.DOCUMENT_NODE */, DOCUMENT_NAME, HTML_NAMESPACE, null);
      ...
      _this[58 /* TransferrableKeys.allowTransfer */] = true;
    ...
    _createClass(Document, [{
      ...
      value: function _(strings, skeleton) {
        ...
        switch (skeleton[0 /* TransferrableKeys.nodeType */]) {
          ...
          default:
            var namespaceURI = strings[skeleton[6 /* TransferrableKeys.namespaceURI */]] || HTML_NAMESPACE;
            var localName = strings[skeleton[1 /* TransferrableKeys.localOrNodeName */]];
            var _constructor = NS_NAME_TO_CLASS["".concat(namespaceURI, ":").concat(localName)] || HTMLElement;
            var node = new _constructor(1 /* NodeType.ELEMENT_NODE */, localName, namespaceURI, this, skeleton[7 /* TransferrableKeys.index */]);
            (skeleton[2 /* TransferrableKeys.attributes */] || []).forEach(function (attribute) {
              return (
            ...
            (skeleton[4 /* TransferrableKeys.childNodes */] || []).forEach(function (child) {
              return node.appendChild(_this2[64 /* TransferrableKeys.hydrateNode */](strings, child));
            });
            return node;
        }
      }
  ...
  function createStorage(document, location, data) {
    ...
    define(storage, 'setItem', {
      value: function value(key, _value) {
        ...
        transfer(document, [12 /* TransferrableMutationType.STORAGE */, 2 /* GetOrSet.SET */, location, store$1(key) + 1, store$1(stringValue) + 1]);
      }
    });
    define(storage, 'removeItem', {
      value: function value(key) {
        delete this[key];
        transfer(document, [12 /* TransferrableMutationType.STORAGE */, 2 /* GetOrSet.SET */, location, store$1(key) + 1, 0 // value == 0 represents deletion.
        ]);
      }
    });
  ...
  function initialize(document, strings, hydrateableNode, cssKeys, globalEventHandlerKeys, _ref, localStorageInit, sessionStorageInit) {
    ...
    (hydrateableNode[4 /* TransferrableKeys.childNodes */] || []).forEach(function (child) {
      return document.body.appendChild(document[64 /* TransferrableKeys.hydrateNode */](strings, child));
    });
    var window = document.defaultView;
  ...
  var SVGElement = /*#__PURE__*/function (_Element) {
    ...
    function SVGElement(nodeType, localName, namespaceURI, ownerDocument) {
      ...
      _this = _super.call(this, nodeType, localName, SVG_NAMESPACE, ownerDocument);
