var WorkerThread = (function (exports) {
    ...
    class AMP {
      ...
      getState(key = '') {
        return new Promise(resolve => {
          ...
          transfer(this.document, [12 /* TransferrableMutationType.STORAGE */, 1 /* GetOrSet.GET */, 2 /* StorageLocation.AmpState */, /* key */store$1(key) + 1, /* value */0]);
    ...
    function callFunctionMessageHandler(event, document) {
      ...
      if (!fn) {
        transfer(document, [13 /* TransferrableMutationType.FUNCTION_CALL */, 2 /* ResolveOrReject.REJECT */, index, store$1(JSON.stringify(`[worker-dom]: Exported function "${fnIdentifier}" could not be found.`))]);
        return;
      }
      ...
      .then(f => f.apply(null, fnArguments)).then(value => {
        ...
        transfer(document, [13 /* TransferrableMutationType.FUNCTION_CALL */, 2 /* ResolveOrReject.REJECT */, index, store$1(JSON.stringify(`[worker-dom]: Function "${fnIdentifier}" threw: "${errorMessage}"`))]);
      });
    }
    ...
    class CharacterData extends Node {
      constructor(data, nodeType, nodeName, ownerDocument, overrideIndex) {
        ...
        this[38 /* TransferrableKeys.data */] = void 0;
        this[38 /* TransferrableKeys.data */] = data;
        this[8 /* TransferrableKeys.creationFormat */] = [this[7 /* TransferrableKeys.index */], nodeType, store$1(nodeName), store$1(data), 0];
      }
      // Unimplemented Methods
    ...
    const elementPredicate = node => node.nodeType === 1 /* NodeType.ELEMENT_NODE */;
    ...
    */
    ...
    function querySelectorAll(node, selector) {
      ...
      return matcher ? matchChildrenElements(node[45 /* TransferrableKeys.scopingRoot */], matcher).filter(element => node !== element && node.contains(element)) : [];
    }
    ...
    class Element extends ParentNode {
      constructor(nodeType, localName, namespaceURI, ownerDocument, overrideIndex) {
        ...
        this[8 /* TransferrableKeys.creationFormat */] = [this[7 /* TransferrableKeys.index */], this.nodeType, store$1(this.localName), 0, this.namespaceURI === null ? 0 : store$1(this.namespaceURI)];
      }
      ...
      set innerHTML(html) {
        ...
        mutate(this.ownerDocument, {
          ...
          type: 2 /* MutationRecordType.CHILD_LIST */,
          target: this
        }, [2 /* TransferrableMutationType.CHILD_LIST */, this[7 /* TransferrableKeys.index */], 0, 0, 0, this.childNodes.length, ...this.childNodes.map(node => node[7 /* TransferrableKeys.index */])]);
      ...
      getBoundingClientRectAsync() {
        ...
        return new Promise(resolve => {
          const messageHandler = ({
            ...
            if (data[12 /* TransferrableKeys.type */] === 6 /* MessageType.GET_BOUNDING_CLIENT_RECT */ && data[13 /* TransferrableKeys.target */][0] === this[7 /* TransferrableKeys.index */]) {
    ...
    class HTMLElement extends Element {
      constructor(...args) {
        super(...args);
        this[76 /* TransferrableKeys.propertyEventHandlers */] = {};
      }
      /**
    ...
    */
    ...
    class CanvasGradient {
      ...
      addColorStop(offset, color) {
        transfer(this.document, [9 /* TransferrableMutationType.OBJECT_MUTATION */, store$1('addColorStop'), 2, ...this[68 /* TransferrableKeys.serializeAsTransferrableObject */](), ...serializeTransferrableObject([...arguments])]);
      }
      [68 /* TransferrableKeys.serializeAsTransferrableObject */]() {
    ...
    class OffscreenCanvasRenderingContext2DPolyfill {
      ...
      [67 /* TransferrableKeys.mutated */](fnName, args) {
        transfer(this.canvasElement.ownerDocument, [9 /* TransferrableMutationType.OBJECT_MUTATION */, store$1(fnName), args.length, ...this[68 /* TransferrableKeys.serializeAsTransferrableObject */](), ...serializeTransferrableObject(args)]);
      }
      [68 /* TransferrableKeys.serializeAsTransferrableObject */]() {
      ...
      createObjectReference(objectId, creationMethod, creationArgs) {
        transfer(this.canvasElement.ownerDocument, [10 /* TransferrableMutationType.OBJECT_CREATION */, store$1(creationMethod), objectId, creationArgs.length, ...this[68 /* TransferrableKeys.serializeAsTransferrableObject */](), ...serializeTransferrableObject(creationArgs)]);
      }
      get canvas() {
    ...
    */
    ...
    class HTMLInputElement extends HTMLElement {
      constructor(...args) {
        ...
        this[21 /* TransferrableKeys.value */] = '';
        this.dirtyValue = false;
        this[47 /* TransferrableKeys.checked */] = false;
      }
    ...
    class HTMLOptionElement extends HTMLElement {
      constructor(...args) {
        super(...args);
        this[52 /* TransferrableKeys.selected */] = false;
      }
      /**
    ...
    class HTMLProgressElement extends HTMLElement {
      constructor(...args) {
        super(...args);
        this[48 /* TransferrableKeys.indeterminate */] = true;
        this[21 /* TransferrableKeys.value */] = 0;
        this.dirtyValue = false;
      }
      get position() {
    ...
    class HTMLSelectElement extends HTMLElement {
      constructor(...args) {
        super(...args);
        this[49 /* TransferrableKeys.size */] = -1 /* SizeDefaults.UNMODIFIED */;
      }
    ...
    class DocumentFragment extends ParentNode {
      constructor(ownerDocument, overrideIndex) {
        ...
        this[8 /* TransferrableKeys.creationFormat */] = [this[7 /* TransferrableKeys.index */], 11 /* NodeType.DOCUMENT_FRAGMENT_NODE */, store$1(this.nodeName), 0, 0];
      }
      /**
       * @param deep boolean determines if the clone should include a recursive copy of all childNodes.
