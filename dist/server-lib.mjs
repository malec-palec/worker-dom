...
class Node {
  ...
  removeEventListener(type, handler) {
    ...
    if (index >= 0) {
      ...
      transfer(this.ownerDocument, [4 /* TransferrableMutationType.EVENT_SUBSCRIPTION */, this[7 /* TransferrableKeys.index */], 1, 0, store(), index]);
    }
  }
  /**
...
class DOMTokenList {
  ...
  [67 /* TransferrableKeys.mutated */](oldValue, value) {
    ...
    mutate(this[13 /* TransferrableKeys.target */].ownerDocument, {
      ...
      value,
      oldValue
    }, [0 /* TransferrableMutationType.ATTRIBUTES */, this[13 /* TransferrableKeys.target */][7 /* TransferrableKeys.index */], store(this[18 /* TransferrableKeys.attributeName */]), 0, value !== null ? store() + 1 : 0]);
  }
}
...
class CSSStyleDeclaration {
  ...
  mutated(value) {
    ...
    mutate(this[13 /* TransferrableKeys.target */].ownerDocument, {
      ...
      value,
      oldValue
    }, [0 /* TransferrableMutationType.ATTRIBUTES */, this[13 /* TransferrableKeys.target */][7 /* TransferrableKeys.index */], store(), 0, value !== null ? store() + 1 : 0]);
  }
}
...
class Element extends ParentNode {
  ...
  setAttributeNS(namespaceURI, name, value) {
    ...
    mutate(this.ownerDocument, {
      ...
      value: valueAsString,
      oldValue
    }, [0 /* TransferrableMutationType.ATTRIBUTES */, this[7 /* TransferrableKeys.index */], store(), store(), value !== null ? store() + 1 : 0]);
  }
  ...
  removeAttributeNS(namespaceURI, name) {
    ...
    if (index >= 0) {
      ...
      mutate(this.ownerDocument, {
        ...
        attributeNamespace: namespaceURI,
        oldValue
      }, [0 /* TransferrableMutationType.ATTRIBUTES */, this[7 /* TransferrableKeys.index */], store(), store(), 0 // 0 means no value
      ]);
    }
  }
  /**
...
function serializeTransferrableObject(args) {
  ...
  for (let i = 0; i < args.length; i++) {
    ...
    if (typeof arg === 'string') {
      serialized.push(3 /* TransferrableObjectType.String */, store());
      continue;
    }
...
class CanvasGradient {
  ...
  addColorStop(offset, color) {
    transfer(this.document, [9 /* TransferrableMutationType.OBJECT_MUTATION */, store(), 2, ...this[68 /* TransferrableKeys.serializeAsTransferrableObject */](), ...serializeTransferrableObject([...arguments])]);
  }
  [68 /* TransferrableKeys.serializeAsTransferrableObject */]() {
...
class OffscreenCanvasRenderingContext2DPolyfill {
  ...
  [67 /* TransferrableKeys.mutated */](fnName, args) {
    transfer(this.canvasElement.ownerDocument, [9 /* TransferrableMutationType.OBJECT_MUTATION */, store(), args.length, ...this[68 /* TransferrableKeys.serializeAsTransferrableObject */](), ...serializeTransferrableObject(args)]);
  }
  [68 /* TransferrableKeys.serializeAsTransferrableObject */]() {
  ...
  createObjectReference(objectId, creationMethod, creationArgs) {
    transfer(this.canvasElement.ownerDocument, [10 /* TransferrableMutationType.OBJECT_CREATION */, store(), objectId, creationArgs.length, ...this[68 /* TransferrableKeys.serializeAsTransferrableObject */](), ...serializeTransferrableObject(creationArgs)]);
  }
  get canvas() {
...
class HTMLInputElement extends HTMLElement {
  ...
  set value(value) {
    ...
    transfer(this.ownerDocument, [3 /* TransferrableMutationType.PROPERTIES */, this[7 /* TransferrableKeys.index */], store(), 0 /* NumericBoolean.FALSE */, store()]);
  }
  get valueAsDate() {
  ...
  set checked(value) {
    ...
    transfer(this.ownerDocument, [3 /* TransferrableMutationType.PROPERTIES */, this[7 /* TransferrableKeys.index */], store(), 1 /* NumericBoolean.TRUE */, value === true ? 1 /* NumericBoolean.TRUE */ : 0 /* NumericBoolean.FALSE */]);
  }
  /**
...
class HTMLOptionElement extends HTMLElement {
  ...
  set selected(value) {
    ...
    transfer(this.ownerDocument, [3 /* TransferrableMutationType.PROPERTIES */, this[7 /* TransferrableKeys.index */], store(), 1 /* NumericBoolean.TRUE */, this[52 /* TransferrableKeys.selected */] ? 1 /* NumericBoolean.TRUE */ : 0 /* NumericBoolean.FALSE */]);
  }
  /**
   * A Synonym for the Node.textContent property getter.
   * @see https://developer.mozilla.org/en-US/docs/Web/API/HTMLOptionElement
...
class CharacterData extends Node {
  constructor(data, nodeType, nodeName, ownerDocument, overrideIndex) {
    ...
    this[8 /* TransferrableKeys.creationFormat */] = [this[7 /* TransferrableKeys.index */], nodeType, store(), store(), 0];
  }
  // Unimplemented Methods
  ...
  set data(value) {
    ...
    mutate(this.ownerDocument, {
      ...
      value,
      oldValue
    }, [1 /* TransferrableMutationType.CHARACTER_DATA */, this[7 /* TransferrableKeys.index */], store()]);
  }
  /**
