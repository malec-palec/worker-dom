    ...
    function transfer(document, mutation) {
      if (phase > 0 /* Phase.Initializing */ && document[58 /* TransferrableKeys.allowTransfer */]) {
        ...
        Promise.resolve().then(_ => {
          if (pending) {
            const nodes = new Uint16Array(consume$1().reduce((acc, node) => acc.concat(node[8 /* TransferrableKeys.creationFormat */]), [])).buffer;
            ...
            document.postMessage({
              ...
              [41 /* TransferrableKeys.strings */]: consume(),
    ...
    */
    ...
    class Element extends ParentNode {
      constructor(nodeType, localName, namespaceURI, ownerDocument, overrideIndex) {
        ...
        this[8 /* TransferrableKeys.creationFormat */] = [this[7 /* TransferrableKeys.index */], this.nodeType, store(this.localName), 0, this.namespaceURI === null ? 0 : store(this.namespaceURI)];
      }
    ...
    */
    ...
    class CanvasGradient {
      ...
      addColorStop(offset, color) {
        transfer(this.document, [9 /* TransferrableMutationType.OBJECT_MUTATION */, store('addColorStop'), 2, ...this[68 /* TransferrableKeys.serializeAsTransferrableObject */](), ...serializeTransferrableObject([...arguments])]);
      }
      [68 /* TransferrableKeys.serializeAsTransferrableObject */]() {
    ...
    class OffscreenCanvasRenderingContext2DPolyfill {
      ...
      [67 /* TransferrableKeys.mutated */](fnName, args) {
        transfer(this.canvasElement.ownerDocument, [9 /* TransferrableMutationType.OBJECT_MUTATION */, store(fnName), args.length, ...this[68 /* TransferrableKeys.serializeAsTransferrableObject */](), ...serializeTransferrableObject(args)]);
      }
      [68 /* TransferrableKeys.serializeAsTransferrableObject */]() {
      ...
      createObjectReference(objectId, creationMethod, creationArgs) {
        transfer(this.canvasElement.ownerDocument, [10 /* TransferrableMutationType.OBJECT_CREATION */, store(creationMethod), objectId, creationArgs.length, ...this[68 /* TransferrableKeys.serializeAsTransferrableObject */](), ...serializeTransferrableObject(creationArgs)]);
      }
      get canvas() {
    ...
    */
    ...
    class CharacterData extends Node {
      constructor(data, nodeType, nodeName, ownerDocument, overrideIndex) {
        ...
        this[8 /* TransferrableKeys.creationFormat */] = [this[7 /* TransferrableKeys.index */], nodeType, store(nodeName), store(data), 0];
      }
      // Unimplemented Methods
    ...
    class DocumentFragment extends ParentNode {
      constructor(ownerDocument, overrideIndex) {
        ...
        this[8 /* TransferrableKeys.creationFormat */] = [this[7 /* TransferrableKeys.index */], 11 /* NodeType.DOCUMENT_FRAGMENT_NODE */, store(this.nodeName), 0, 0];
      }
      /**
       * @param deep boolean determines if the clone should include a recursive copy of all childNodes.
