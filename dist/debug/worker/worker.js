var WorkerThread = (function (exports) {
  ...
  function storeOverride(node, override) {
    if (phase === 0 /* Phase.Initializing */) {
      mapping$1.set(node[7 /* TransferrableKeys.index */] = override, node);
  ...
  function store$1(node) {
    ...
    mapping$1.set(node[7 /* TransferrableKeys.index */] = ++count$1, node);
    if (phase > 0 /* Phase.Initializing */) {
    ...
    if (phase > 0 /* Phase.Initializing */ && document[58 /* TransferrableKeys.allowTransfer */]) {
      ...
      Promise.resolve().then(function (_) {
        if (pending) {
          ...
          document.postMessage(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, 54 /* TransferrableKeys.phase */, phase), 12 /* TransferrableKeys.type */, phase === 2 /* Phase.Mutating */ ? 3 /* MessageType.MUTATE */ : 2), 37 /* TransferrableKeys.nodes */, nodes), 41 /* TransferrableKeys.strings */, consume()), 36 /* TransferrableKeys.mutations */, mutations), [nodes, mutations]);
          pendingMutations$1 = [];
          pending = false;
  ...
  var Node = /*#__PURE__*/function () {
    function Node(nodeType, nodeName, ownerDocument, overrideIndex) {
      ...
      this[7 /* TransferrableKeys.index */] = overrideIndex ? storeOverride(this, overrideIndex) : store$1(this);
    ...
    _createClass(Node, [{
      ...
      value: function removeEventListener(type, handler) {
        ...
        if (index >= 0) {
          ...
          transfer(this.ownerDocument, [4 /* TransferrableMutationType.EVENT_SUBSCRIPTION */, this[7 /* TransferrableKeys.index */], 1, 0, store(lowerType), index]);
        }
      }
      /**
  ...
  */
    ...
    _createClass(DOMTokenList, [{
      ...
      value: function _(oldValue, value) {
        ...
        mutate(this[13 /* TransferrableKeys.target */].ownerDocument, {
          ...
          value: value,
          oldValue: oldValue
        }, [0 /* TransferrableMutationType.ATTRIBUTES */, this[13 /* TransferrableKeys.target */][7 /* TransferrableKeys.index */], store(this[18 /* TransferrableKeys.attributeName */]), 0, value !== null ? store(value) + 1 : 0]);
      }
    }]);
    return DOMTokenList;
  }();
    ...
    _createClass(CSSStyleDeclaration, [{
      ...
      value: function mutated(value) {
        ...
        mutate(this[13 /* TransferrableKeys.target */].ownerDocument, {
          ...
          value: value,
          oldValue: oldValue
        }, [0 /* TransferrableMutationType.ATTRIBUTES */, this[13 /* TransferrableKeys.target */][7 /* TransferrableKeys.index */], store('style'), 0, value !== null ? store(value) + 1 : 0]);
      }
    }]);
  ...
  var Element = /*#__PURE__*/function (_ParentNode) {
    ...
    function Element(nodeType, localName, namespaceURI, ownerDocument, overrideIndex) {
      ...
      _this[8 /* TransferrableKeys.creationFormat */] = [_this[7 /* TransferrableKeys.index */], _this.nodeType, store(_this.localName), 0, _this.namespaceURI === null ? 0 : store(_this.namespaceURI)];
      return _this;
    }
    ...
    _createClass(Element, [{
      ...
      value: function setAttributeNS(namespaceURI, name, value) {
        ...
        mutate(this.ownerDocument, {
          ...
          value: valueAsString,
          oldValue: oldValue
        }, [0 /* TransferrableMutationType.ATTRIBUTES */, this[7 /* TransferrableKeys.index */], store(name), store(namespaceURI), value !== null ? store(valueAsString) + 1 : 0]);
      }
    }, {
      key: "44",
      ...
      value: function removeAttributeNS(namespaceURI, name) {
        ...
        if (index >= 0) {
          ...
          mutate(this.ownerDocument, {
            ...
            attributeNamespace: namespaceURI,
            oldValue: oldValue
          }, [0 /* TransferrableMutationType.ATTRIBUTES */, this[7 /* TransferrableKeys.index */], store(name), store(namespaceURI), 0 // 0 means no value
          ]);
        }
      }
      /**
  ...
  var CanvasGradient = /*#__PURE__*/function () {
    ...
    _createClass(CanvasGradient, [{
      ...
      value: function addColorStop(offset, color) {
        transfer(this.document, [9 /* TransferrableMutationType.OBJECT_MUTATION */, store('addColorStop'), 2].concat(_toConsumableArray(this[68 /* TransferrableKeys.serializeAsTransferrableObject */]()), _toConsumableArray(serializeTransferrableObject(Array.prototype.slice.call(arguments)))));
      }
    }, {
      key: "68",
      value: function _() {
  ...
  var OffscreenCanvasRenderingContext2DPolyfill = /*#__PURE__*/function () {
    ...
    _createClass(OffscreenCanvasRenderingContext2DPolyfill, [{
      ...
      value: function _(fnName, args) {
        transfer(this.canvasElement.ownerDocument, [9 /* TransferrableMutationType.OBJECT_MUTATION */, store(fnName), args.length].concat(_toConsumableArray(this[68 /* TransferrableKeys.serializeAsTransferrableObject */]()), _toConsumableArray(serializeTransferrableObject(args))));
      }
    }, {
      key: "68",
      value: function _() {
      ...
      value: function createObjectReference(objectId, creationMethod, creationArgs) {
        transfer(this.canvasElement.ownerDocument, [10 /* TransferrableMutationType.OBJECT_CREATION */, store(creationMethod), objectId, creationArgs.length].concat(_toConsumableArray(this[68 /* TransferrableKeys.serializeAsTransferrableObject */]()), _toConsumableArray(serializeTransferrableObject(creationArgs))));
      }
    }, {
      key: "canvas",
      get: function get() {
  ...
  */
  ...
  var HTMLInputElement = /*#__PURE__*/function (_HTMLElement) {
    ...
    _createClass(HTMLInputElement, [{
      ...
      set: function set(value) {
        ...
        transfer(this.ownerDocument, [3 /* TransferrableMutationType.PROPERTIES */, this[7 /* TransferrableKeys.index */], store('value'), 0 /* NumericBoolean.FALSE */, store(value)]);
      }
    }, {
      key: "valueAsDate",
      get: function get() {
      ...
      set: function set(value) {
        ...
        transfer(this.ownerDocument, [3 /* TransferrableMutationType.PROPERTIES */, this[7 /* TransferrableKeys.index */], store('checked'), 1 /* NumericBoolean.TRUE */, value === true ? 1 /* NumericBoolean.TRUE */ : 0 /* NumericBoolean.FALSE */]);
      }
      /**
  ...
  var HTMLOptionElement = /*#__PURE__*/function (_HTMLElement) {
    ...
    _createClass(HTMLOptionElement, [{
      ...
      set: function set(value) {
        ...
        transfer(this.ownerDocument, [3 /* TransferrableMutationType.PROPERTIES */, this[7 /* TransferrableKeys.index */], store('selected'), 1 /* NumericBoolean.TRUE */, this[52 /* TransferrableKeys.selected */] ? 1 /* NumericBoolean.TRUE */ : 0 /* NumericBoolean.FALSE */]);
      }
      /**
       * A Synonym for the Node.textContent property getter.
       * @see https://developer.mozilla.org/en-US/docs/Web/API/HTMLOptionElement
  ...
  var CharacterData = /*#__PURE__*/function (_Node) {
    ...
    function CharacterData(data, nodeType, nodeName, ownerDocument, overrideIndex) {
      ...
      _this[8 /* TransferrableKeys.creationFormat */] = [_this[7 /* TransferrableKeys.index */], nodeType, store(nodeName), store(data), 0];
      return _this;
    }
    // Unimplemented Methods
    ...
    _createClass(CharacterData, [{
      ...
      set: function set(value) {
        ...
        mutate(this.ownerDocument, {
          ...
          value: value,
          oldValue: oldValue
        }, [1 /* TransferrableMutationType.CHARACTER_DATA */, this[7 /* TransferrableKeys.index */], store(value)]);
      }
      /**
  ...
  var DocumentFragment = /*#__PURE__*/function (_ParentNode) {
    ...
    function DocumentFragment(ownerDocument, overrideIndex) {
      ...
      _this[8 /* TransferrableKeys.creationFormat */] = [_this[7 /* TransferrableKeys.index */], 11 /* NodeType.DOCUMENT_FRAGMENT_NODE */, store(_this.nodeName), 0, 0];
      return _this;
    }
    /**
     * @param deep boolean determines if the clone should include a recursive copy of all childNodes.
